 ...
 * - Добавить отображение времени для разрешения обнулить статистику. +
 * - Попробовать в конце сделать общий лог по выданым очкам.
 * - Сделать клатч топ (Брать зачение макс. кмлла и очек).
 * - Сделать возможность отключить ранги.
 * - Сделать подсчет: Дамага за раунд, Количество спесений тимейтов, Количество спасений тимейтами.
 * ------------------------------------------------------------------------------------------------
